 ...
 *
 * $Id: sha1.c,v 1.4 2001/03/06 00:12:16 robert Exp $
 */

/* Eduard Bloch, 2008: disabled code parts not used in apt-cacher-ng
 * and renamed to sha1.cc for convenience, and use config.h */
...
#ifndef SWAP_DONE
#error Unknown byte order or size of long -- you need to add code here
#endif /* SWAP_DONE */
